  ...
  return (
    <footer className="bg-gray-900 text-white py-16 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-10 right-10 w-32 h-32 border border-blue-400/20 rounded-full opacity-20"
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="mb-3">
              <Image src="/logo.png" alt="Bell Wedding Planners" width={200} height={120} className="h-32 w-auto" />
            </div>
            ...
            <div className="flex space-x-4">
              {[Instagram, Facebook, Twitter].map((Icon, index) => (
                <motion.div key={index} whileHover={{ scale: 1.1, y: -2 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    size="icon"
                    className="bg-gray-800 border border-gray-700 hover:border-blue-400 hover:bg-blue-500 rounded-xl"
                  >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold text-blue-400 mb-6">Quick Links</h3>
            <ul className="space-y-3">
              {footerLinks.quickLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-300 hover:text-blue-400 transition-colors relative group">
                    {link.label}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="text-lg font-semibold text-blue-400 mb-6">Contact Info</h3>
